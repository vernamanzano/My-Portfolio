...
<template>
  <main class="font-Jakarta container my-16 px-4 text-dark-charcoal">
    <header class="text-6xl lg:text-8xl font-bold">
      I can learn anything. <br class="block md:hidden" />
      I can know anything. <br class="block md:hidden" />
      I can be anything.
    </header>

    <div class="grid grid-none lg:grid-cols-3 gap-8 xl:gap-32 my-20 text-xl">
      <div class="space-y-8">
        <p>Hi, my name is Verna and that quote above is what keeps me going.</p>

        <div>
          <h2 class="font-semibold">Embracing the Unexpected</h2>
          <div class="space-y-8">
            <p>
              In this ever-evolving digital landscape, I've come to appreciate
              that adaptability and a thirst for learning are my strongest
              assets.
            </p>
            <p>
              After college, I decided to hone my technical skills by studying
              and by the help of my mentor in the IT field.
            </p>
          </div>
        </div>
      </div>
      <div>
        <p>
          If you're wondering how I fit into the world of design and web
          development, the answer is simple:

          <br />
          <br />

          I'm here to bridge the gap between storytelling and technology.
        </p>
        <br />
        <h2 class="font-semibold">Let's connect!</h2>
      </div>
      <div>
        <div>
          <p>
            If you're looking for a creative collaborator or just want to swap
            stories, feel free to reach out.
          </p>
          <br />
          <p>
            Your digital dreamweaver,
            <img class="my-4" src="../assets/images/signature.png" />
          </p>
        </div>

        <div class="flex justify-start gap-2 pt-8 pl-1">
          <a
            href="https://mail.google.com/mail/u/1/?view=cm&fs=1&to=manzano.vernalyn@gmail.com&tf=1"
            target="_blank"
          >
            <svg
              width="32"
          ...
          <a
            href="https://www.linkedin.com/in/vernalynmanzano/"
            target="_blank"
          >
            <svg
              width="32"
    ...
    <div class="xl:w-2/3">
      <ul class="flex flex-wrap text-sm md:text-regular">
        ...
        <li class="skill">PHP Laravel</li>
        <li class="skill">Laragon</li>
        ...
        <li class="skill">Adobe Premiere Pro</li>
        <li class="skill">Canva</li>
        <li class="skill">Adobe Audition</li>
        <li class="skill">OBS Studio</li>
