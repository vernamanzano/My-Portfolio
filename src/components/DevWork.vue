...
<template>
    <div id="dev-work-section" class="pt-20 space-y-4 text-dark-charcoal">
        ...
        <div>
            <div class="space-y-4">
                ...
                <ul class="list-disc pl-5 lg:w-1/2 space-y-2">
                    ...
                    <li>
                        Developed user-friendly web pages for both administrators and clients, for app management and integration into their websites.
                    </li>
                </ul>
            </div>

            <div>
                <img class="mx-auto my-8" src="../assets/images/aceada-3d-mockup.png">
            </div>
        </div>
        ...
        <div class="py-8">
            <div class="space-y-4">
                ...
                <ul class="list-disc pl-5 lg:w-1/2 space-y-2">
                    ...
                    <li>
                        Implemented a test library for candidate assessment, aiding employers in evaluating job skills, personality traits, and compatibility.
                    </li>
                </ul>
            </div>

            <div>
                <img class="mx-auto my-8" src="../assets/images/easyhire-mockup.png">
            </div>
        </div>
        ...
        <div>
            ...
            <div>
                <img class="mx-auto w-2/3 my-8" src="../assets/images/legacy-restock-mockup.png">
            </div>
        </div>
    </div>
