...
<template>
    <div id="design-work-section" class="pt-20 space-y-4 text-dark-charcoal">
        <div class="flex items-end justify-between mb-8">
            <h2 class="text-5xl md:text-8xl font-semibold text-dark-charcoal">
                Design <br class="flex md:hidden"> Work
            </h2>
            <div class="bg-dark-charcoal text-white rounded-full px-4 py-2 mb-1">
                2023 - 2022
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="flex">
                    <img class="w-1/2 shadow-xl" src="../assets\images\fresh-start-1.png" alt="fresh start payday sale poster">
                    <img class="w-1/2 first-letter:shadow-xl" src="../assets\images\fresh-start-2.png" alt="fresh start payday sale poster">
                </div>
            </div>
            <div>
